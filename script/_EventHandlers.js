...
DefaultHandler.prototype.MouseDown = function(pos)
{
    ...
    this.downSelected = selectedObject;    

    this.needRedraw = true;
    this.pressed = true;
    this.prevPosition = pos;

    if (this.selectedObjects.includes(selectedObject) || selectedObject == this.selectedObject) {
        this.app.canvas.style.cursor = "move";

        if ((selectedObject instanceof BaseVertex) && selectedObject != null && selectedObject == this.selectedObject) {
...
DefaultHandler.prototype.MouseUp = function(pos) 
{
    var selectedObject = this.GetSelectedObject(pos);
    var severalSelect = g_ctrlPressed;
    if (this.downSelected != selectedObject) {
        selectedObject = null;
        this.downSelected = null;
    }

    if (!severalSelect && !this.selectedObjects.includes(selectedObject)) {
        this.selectedObject = null;
        this.selectedObjects = [];
        this.groupingSelect = g_ctrlPressed;
    }
